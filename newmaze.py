...
class Maze(gym.Env):
    def __init__(self, pixels =40, fixed = True):
    ...
    def initial_pos(self):
        pos = random.randint(0, (self.N*self.N)-1)
        
        while pos in self.trees\
            or pos in self.final_cricket\
            or pos in self.inter_cricket\
